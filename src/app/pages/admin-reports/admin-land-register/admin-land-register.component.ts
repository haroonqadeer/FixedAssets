...
export class AssetItems {
  ...
  district: string;
  yearAcq: string;
  amountCompensate: number;
  landTransfered: string;
  remarks: string;
}

@Component({
  selector: "app-admin-land-register",
  templateUrl: "./admin-land-register.component.html",
  styleUrls: ["./admin-land-register.component.scss"],
})
export class AdminLandRegisterComponent implements OnInit {
    ...
    this.columns = [
      {
        ...
        title: "Name of Project and Number of National Highway",
        display: true,
      },
      {
        field: "areaLand",
        title: "Area of Land Acquired",
        display: true,
      },
      {
        field: "district",
      ...
      {
        field: "amountCompensate",
        title: "Amount of compensation paid to Affectees",
        display: true,
      },
      {
        field: "landTransfered",
        title: "Land Transferred to NHA",
        display: true,
      },
      {
        field: "remarks",
    ...
    if (sort.active && sort.direction !== "") {
      ...
      data = data.sort((a: AssetItems, b: AssetItems) => {
        ...
        switch (sort.active) {
          ...
          case "areaLand":
            return this.compare(a.areaLand, b.areaLand, isAsc);
          case "district":
            return this.compare(a.district, b.district, isAsc);
          case "yearAcq":
            return this.compare(a.yearAcq, b.yearAcq, isAsc);
          case "amountCompensate":
            return this.compare(a.amountCompensate, b.amountCompensate, isAsc);
          case "landTransfered":
            return this.compare(a.landTransfered, b.landTransfered, isAsc);
          default:
            return 0;
        }
      });
