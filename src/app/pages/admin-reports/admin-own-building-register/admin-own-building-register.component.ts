...
@Component({
  selector: "app-admin-own-building-register",
  templateUrl: "./admin-own-building-register.component.html",
  styleUrls: ["./admin-own-building-register.component.scss"],
})
export class AdminOwnBuildingRegisterComponent implements OnInit {
  @ViewChild(MatSort) sort: MatSort;

  tempRptTitle = "";
  rptTitle = "Own Building";
  rptHeader = "";
  rptTitle2nd = "";
  ...
  constructor(
    ...
    this.columns = [
      ...
      {
        field: "areaPlot",
        title: "Area of Plot in Square meters",
        display: true,
      },
      {
        field: "landCost",
        title: "Cost of Land/ Plot with date of purchase",
        display: true,
      },
      {
        field: "costConstruction",
        title: "Quantity PurchasCost of Construction of Building",
        display: true,
      },
      {
        field: "projectName",
      ...
      },
      {
        field: "areaCovered",
        title:
          "Name of Project/ Head from where Plot purchased/ building constructed",
        display: true,
      },
      {
    ...
    if (sort.active && sort.direction !== "") {
      ...
      data = data.sort((a: AssetItems, b: AssetItems) => {
        ...
        switch (sort.active) {
          ...
          case "fullAddress":
            return this.compare(a.fullAddress, b.fullAddress, isAsc);
          case "areaPlot":
            return this.compare(a.areaPlot, b.areaPlot, isAsc);
          case "landCost":
            return this.compare(a.landCost, b.landCost, isAsc);
