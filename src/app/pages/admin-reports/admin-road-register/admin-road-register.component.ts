...
@Component({
  selector: "app-admin-road-register",
  templateUrl: "./admin-road-register.component.html",
  styleUrls: ["./admin-road-register.component.scss"],
})
export class AdminRoadRegisterComponent implements OnInit {
  @ViewChild(MatSort) sort: MatSort;

  tempRptTitle = "";
  rptTitle = "Roads Assets Record";
  rptHeader = "";
  rptTitle2nd = "";
    ...
    this.columns = [
      {
        ...
        title: "Description of National Highway",
        display: true,
      },
      {
        field: "dateOfNational",
        title: "Date of year of Nationalization of a road",
        display: true,
      },
      {
        field: "length",
        title: "Cost oTotal Length of Road",
        display: true,
      },
      {
      ...
      },
      {
        ...
        title: "Cost Spent on construction except Land",
        display: true,
      },
      {
        field: "totalLand",
        title: "Total Land Acquired/ under the Road",
        display: true,
      },
      {
        field: "costLand",
    ...
    if (sort.active && sort.direction !== "") {
      ...
      data = data.sort((a: AssetItems, b: AssetItems) => {
        ...
        switch (sort.active) {
          ...
          case "dateOfNational":
            return this.compare(a.dateOfNational, b.dateOfNational, isAsc);
          case "length":
            return this.compare(a.length, b.length, isAsc);
          case "yearConstruction":
            return this.compare(a.yearConstruction, b.yearConstruction, isAsc);
          case "totalLand":
            return this.compare(a.totalLand, b.totalLand, isAsc);
          case "costLand":
            return this.compare(a.costLand, b.costLand, isAsc);
          case "remarks":
