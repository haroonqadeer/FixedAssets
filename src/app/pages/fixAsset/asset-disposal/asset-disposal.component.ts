...
export class AssetDisposalComponent implements OnInit {
  ...
  getDisposalDetail() {
    ...
    this.http
      .get(
        this.app.serverUrl + "disposaldetail?disposalid=" + this.disposalID,
        { headers: reqHeader }
      )
      .subscribe((data: any) => {
  ...
  save() {
    if (this.toDate == undefined || this.toDate == null) {
      ...
      this.toastr.errorToastr("Please Enter Party Name", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    }
    ...
    // }
      ...
      (this.ntnNo == undefined || this.ntnNo == "" || this.ntnNo.length < 8) &&
      (this.cnicNo == undefined || this.cnicNo == "" || this.cnicNo.length < 13)
    ) {
      this.toastr.errorToastr("Please Enter NTN Or CNIC Number", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    }
    ...
    // }
      ...
      this.toastr.errorToastr("Please Enter Tax Amount", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else {
      ...
      this.http
        .post(this.app.serverUrl + "suddisposal", SaveData, {
          headers: reqHeader,
        })
        .subscribe((data: any) => {
          if (data.msg == "Success") {
  ...
  saveDetail() {
    if (this.ddlAssets == undefined || this.ddlAssets == null) {
      ...
      this.costOfAsset == undefined ||
      this.ddlLocation.toString() == ""
    ) {
      ...
      this.accumlateDepreciation == undefined ||
      this.accumlateDepreciation.toString() == ""
    ) {
      this.toastr.errorToastr(
        "Please Enter Accumlate Depreciation",
        "Error !",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.revaluedAmount == undefined ||
      this.revaluedAmount.toString() == ""
    ) {
      ...
      this.disposalValue == undefined ||
      this.disposalValue.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Disposal Value", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (this.gainLoss == undefined || this.gainLoss.toString() == "") {
      this.toastr.errorToastr("Please Enter Gain/Loss", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.reservePrice == undefined ||
      this.reservePrice.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Reserve Price", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.currentMarketValue == undefined ||
      this.currentMarketValue.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Current Markeet Value", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else {
      ...
      var fileNameExt = this.filePickerDetail.substr(
        this.filePickerDetail.lastIndexOf(".") + 1
      );
      ...
      this.http
        .post(this.app.serverUrl + "suddisposaldetail", SaveData, {
          headers: reqHeader,
        })
        .subscribe((data: any) => {
          if (data.msg == "Success") {
  ...
  filterAssetDetail(reqAssetId) {
    ...
    var tempList = this.assetsForDisposalDataList.filter(
    ...
    if (tempList.length > 0) {
      ...
      if (
        tempList[0].AccDepreciationonCost != 0 &&
        tempList[0].AccDepreciationonCost != undefined
      ) {
      ...
      if (
        tempList[0].NetBookValue != 0 &&
        tempList[0].NetBookValue != undefined
      ) {
