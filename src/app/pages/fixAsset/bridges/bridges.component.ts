...
export class BridgesComponent implements OnInit {
    ...
    getAccSec() {
        ...
        this.http.get(this.serverUrl + "getaccsec", { headers: reqHeader }).subscribe((data: any) => {
    ...
    getProjects() {
        ...
        this.http.get(this.serverUrl + "getprojects?IsActivated=1", { headers: reqHeader }).subscribe((data: any) => {
    ...
    getRoads() {
        ...
        this.http.get(this.serverUrl + "getroads", { headers: reqHeader }).subscribe((data: any) => {
            this.roadsList = data;
            this.loadingBar = false;
        });
    }
    ...
    getLandMeasurement() {
        ...
        this.http.get(this.serverUrl + "getlandmeasurement", { headers: reqHeader }).subscribe((data: any) => {
    ...
    getBridgeData() {
        ...
        this.http.get(this.serverUrl + "getbridgedata", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    getFaDetail() {
        ...
        this.http.get(this.serverUrl + "getfadetail", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    getFaSummary() {
        ...
        this.http.get(this.serverUrl + "getfasummary", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    getTransactions() {
        ...
        this.http.get(this.serverUrl + "gettransaction", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    save() {
        ...
        if (this.bridgeLength == undefined || this.bridgeLength == '' || this.bridgeLength == null ) {
            bLength = 0;
        }else{
            bLength = this.bridgeLength;
        }

        if (this.constructionCost == undefined || this.constructionCost == '' || this.constructionCost == null ) {
            cCost = 0;
        }else{
            cCost = this.constructionCost;
        }

        if (this.landCost == undefined || this.landCost == '' || this.landCost == null ) {
            lCost = 0;
        }else{
            lCost = this.landCost;
        }
        ...
        if (this.ddlAccSec == undefined || this.ddlAccSec == "") {
            this.toastr.errorToastr("Please Select Account Section", "Error !", {toastTimeout: 2500, });
            return false;
        } 
        ...
        // } 
            ...
            this.toastr.errorToastr("Please Select Project", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.projectPackage == undefined || this.projectPackage.trim() == "") {
            this.toastr.errorToastr("Please Enter Project Package", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.bridgeName == undefined || this.bridgeName == "") {
            this.toastr.errorToastr("Please Enter Bridge Name", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (bLength == 0 ) {
            this.toastr.errorToastr("Please Enter Bridge Length", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.ddlRoads == undefined || this.ddlRoads == "") {
            this.toastr.errorToastr("Please Select Road", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.nationalizationDate == undefined || this.nationalizationDate == null) {
            this.toastr.errorToastr("Please Enter Date of Nationalization", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.cfDate == undefined || this.cfDate == null) {
            this.toastr.errorToastr("Please Enter Date of Construction From", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.ctDate == undefined || this.ctDate == null) {
            this.toastr.errorToastr("Please Enter Date of Construction To", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.ddlLandMeasurement == undefined || this.ddlLandMeasurement == "") {
            this.toastr.errorToastr("Please Select Area Accuired Measurement Unit", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (aKanal == 0 && aMarla == 0) {
            this.toastr.errorToastr("Please Enter Area Acquired", "Error !", {toastTimeout: 2500,});
            return false;
        }
        else {
            ...
            this.http.post(this.serverUrl + "sudbridge", SaveData, { headers: reqHeader }).subscribe((data: any) => {
                if (data.msg == "Success") {
                    if (this.fixAssetID == 0) {
    ...
    delete(item) {
        ...
        Swal.fire({
            ...
            this.http.post(this.serverUrl + "sudland", SaveData, { headers: reqHeader }).subscribe((data: any) => {
                if (data.msg == "Success") {
    ...
    saveAD() {
        ...
        if (this.txtFaAmount == undefined ||  parseFloat(this.txtFaAmount) < 0) {
            this.toastr.errorToastr("Please Enter Addition In Cost", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.txtFaCost == undefined || parseFloat(this.txtFaCost) < 0) {
            this.toastr.errorToastr("Please Enter Disposal In Cost", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (parseFloat(this.txtFaAmount) == 0 &&  parseFloat(this.txtFaCost) == 0 ) {
            this.toastr.errorToastr("Please Enter Addition In Cost / Disposal In Cost", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.txtFaDate == undefined || this.txtFaDate == null) {
            this.toastr.errorToastr("Please Enter Date", "Error !", {toastTimeout: 2500,});
            return false;
    ...
    saveOV() {
        ...
        if (this.txtFaAmount == undefined ||  parseFloat(this.txtFaAmount) < 0) {
            ...
            this.toastr.errorToastr("Please Enter Surplus Cost", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (parseFloat(this.txtFaAmount) == 0 &&  parseFloat(this.txtFaCost) == 0 ) {
            this.toastr.errorToastr("Please Enter Opening Cost / Surplus", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.txtFaDate == undefined || this.txtFaDate == null) {
            this.toastr.errorToastr("Please Enter Date", "Error !", {toastTimeout: 2500,});
            return false;
    ...
    saveRV() {
        ...
        if (this.txtFaAmount == undefined ||  parseFloat(this.txtFaAmount) < 0) {
            ...
            this.toastr.errorToastr("Please Enter Revaluation Surplus", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (parseFloat(this.txtFaAmount) == 0 &&  parseFloat(this.txtFaCost) == 0 ) {
            this.toastr.errorToastr("Please Enter Revaluation Amount / Revaluation Surplus", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.txtFaDate == undefined || this.txtFaDate == null) {
            this.toastr.errorToastr("Please Enter Date", "Error !", {toastTimeout: 2500,});
            return false;
    ...
    filterProject(reqProjectID, filterBy) {
        ...
        if(filterBy == ''){
            ...
            this.ddlProject = '';
            var tempList = this.projectsList.filter((x) => x.projectID == reqProjectID && x.accountCode > 0);
    ...
    filterFaDetail(reqFixAssetID, filterBy) {
        ...
        if(filterBy == 'oc'){
            ...
            this.oFaDetailList = [];
            var tempList = this.faDetailList.filter((x) => x.fixedAssetID == reqFixAssetID && x.openingCost != 0);
        ...
        if (filterBy == 'a'){
            ...
            this.aFaDetailList = [];
            var tempList = this.faDetailList.filter((x) => x.fixedAssetID == reqFixAssetID && (x.additioninCost != 0 || x.disposalinCost != 0));
        ...
        if (filterBy == 'ov'){
            ...
            this.ovFaDetailList = [];
            var tempList = this.faDetailList.filter((x) => x.fixedAssetID == reqFixAssetID && x.openingRevaluationAmount != 0 );
        ...
        if (filterBy == 'v'){
            ...
            this.vFaDetailList = [];
            var tempList = this.faDetailList.filter((x) => x.fixedAssetID == reqFixAssetID && x.revaluationAmount != 0);
        ...
        if (filterBy == 't'){
            ...
            var tempList = this.faSummaryList.filter((x) => x.fixedAssetID == reqFixAssetID);

            if(tempList.length > 0 ){
                this.lblOpeningCost = tempList[0].openingCost;
                this.lblAddition = tempList[0].additioninCost + tempList[0].disposalinCost;
        ...
        if (filterBy == 'td'){
            ...
            this.tempTransactionList = [];
            var tempList = this.transactionList.filter((x) => x.fixedAssetID == reqFixAssetID);
