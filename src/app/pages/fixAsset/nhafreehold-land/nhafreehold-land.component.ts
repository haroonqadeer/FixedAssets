...
export class NHAFreeholdLandComponent implements OnInit {
  ...
  //accordian settings end
    ...
    getLandData() {
        ...
        this.http.get(this.serverUrl + "getlanddata", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    save() {
        ...
        // } 
            ...
            return false;
        } else if (this.purposeOfPurchase == undefined || this.purposeOfPurchase.trim() == "") {
            this.toastr.errorToastr("Please Enter Purpose of Purchase", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.presentUse == undefined || this.presentUse == "") {
            this.toastr.errorToastr("Please Enter Present Use", "Error !", {toastTimeout: 2500,});
            return false;
        } else if (this.acquisitionDate == undefined || this.acquisitionDate == null) {
            this.toastr.errorToastr("Please Enter Year of Acquisition", "Error !", {toastTimeout: 2500,});
            return false;
        } 
