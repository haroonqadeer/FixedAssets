...
export class WriteOffComponent implements OnInit {
  ...
  getWriteOff() {
    ...
    this.http
      .get(this.app.serverUrl + "getWriteOffList", { headers: reqHeader })
      .subscribe((data: any) => {
  ...
  getWriteOffDetail() {
    ...
    this.http
      .get(
        this.app.serverUrl +
          "getWriteOffDetailList?writeOffID=" +
          this.writeOffID,
        { headers: reqHeader }
      )
      .subscribe((data: any) => {
  ...
  getEmpDetail() {
    ...
    this.http
      .get(
        this.app.serverUrl + "getEmpDetail?userID=" + this.cookie.get("userID"),
        { headers: reqHeader }
      )
      .subscribe((data: any) => {
        this.empList = data;
  ...
  save() {
    if (this.wOffDate == undefined || this.wOffDate == null) {
      this.toastr.errorToastr("Please Enter Write Off Date", "Error !", {
        toastTimeout: 2500,
      });
      return false;
      ...
      this.toastr.errorToastr("Please Enter loss Description", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtTotalLoss == undefined ||
      this.txtTotalLoss.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Total Loss", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (this.ddlInquiry == undefined || this.ddlInquiry == "") {
      this.toastr.errorToastr("Please Select Inquiry Conducted by", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtInqRemarks == undefined ||
      this.txtInqRemarks.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Inquiry Remarks", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (this.ddlWOAppBy == undefined || this.ddlWOAppBy == "") {
      this.toastr.errorToastr("Please Select WriteOff Approved By", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtAmountApp == undefined ||
      this.txtAmountApp.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Amount Approved", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtLossRec == undefined ||
      this.txtLossRec.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Loss To Recover", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else {
      ...
      var appFPath =
        "C:/inetpub/wwwroot/FAR/FAR_Project/assets/ApprovedWriteOff";
      ...
      this.http
        .post(this.app.serverUrl + "saveWriteOff", SaveData, {
          headers: reqHeader,
        })
        .subscribe((data: any) => {
          if (data.msg == "Success") {
  ...
  filterAssetDetail(reqAssetId) {
    ...
    var tempList = this.assetsForWriteOffList.filter(
      (x) => x.assetID == reqAssetId
    );
    ...
    if (tempList.length > 0) {
      ...
      if (
        tempList[0].accDepreciationCost != 0 &&
        tempList[0].accDepreciationCost != undefined
      ) {
      ...
      if (
        tempList[0].netBookAmount != 0 &&
        tempList[0].netBookAmount != undefined
      ) {
        this.txtBookValue = tempList[0].netBookAmount;
        this.disBookVal = true;
      }
      if (
        tempList[0].revaluedAmount != 0 &&
        tempList[0].revaluedAmount != undefined
      ) {
  ...
  saveEmployee() {
    if (this.txtEmpName == undefined || this.txtEmpName.trim() == "") {
      this.toastr.errorToastr("Please Enter Employee Name", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (this.ddlDesignation == undefined || this.ddlDesignation == "") {
      this.toastr.errorToastr("Please Select LocatioDesignation", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtLossValueShr == undefined ||
      this.txtLossValueShr.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Value of Loss Share", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else {
      ...
      this.http
        .post(this.app.serverUrl + "saveEmployee", SaveData, {
          headers: reqHeader,
        })
        .subscribe((data: any) => {
          if (data.msg == "Success") {
  ...
  saveDetail() {
    if (this.ddlAssets == undefined || this.ddlAssets == null) {
      ...
      this.txtCOAsset == undefined ||
      this.txtCOAsset.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Cost of Asset", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtDepCharge == undefined ||
      this.txtDepCharge.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Depreciation Charged", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtBookValue == undefined ||
      this.txtBookValue.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Book Value", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtRevalAmount == undefined ||
      this.txtRevalAmount.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Revalued Amount", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      this.txtResValue == undefined ||
      this.txtResValue.toString() == ""
    ) {
      this.toastr.errorToastr("Please Enter Reserved Price", "Error !", {
        toastTimeout: 2500,
      });
      return false;
    } else if (
      ...
      this.toastr.errorToastr(
        "Please Enter Value of Loss Approved",
        "Error !",
        { toastTimeout: 2500 }
      );
      return false;
    } else if (
      this.txtTotLossShr == undefined ||
      this.txtTotLossShr.toString() == ""
    ) {
      this.toastr.errorToastr(
        "Please Enter Total Value of Loss Share",
        "Error !",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.toastr.errorToastr(
        "Total Loss Share & Loss b/w Employees not Equal",
        "Error !",
        { toastTimeout: 2500 }
      );
      return false;
      ...
      this.http
        .post(this.app.serverUrl + "saveWriteOffDetail", SaveData, {
          headers: reqHeader,
        })
        .subscribe((data: any) => {
          if (data.msg == "Success") {
  ...
  editDetail(item) {
    ...
    this.lblAssets =
      item.tag + " - " + item.assetDescription + " - " + item.assetLocation;
