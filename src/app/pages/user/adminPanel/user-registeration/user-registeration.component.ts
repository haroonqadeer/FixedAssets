...
export class UserRegisterationComponent implements OnInit {
    ...
    getPosts() {
        ...
        this.http.get(this.serverUrl + "getposts?IsActivated=0", {headers: reqHeader,}).subscribe((data: any) => {
            this.postsList = data;
        });
    }
    ...
    getRoles() {
        ...
        this.http.get(this.serverUrl + "getroles?IsActivated=0", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    getLocations() {
        ...
        this.http.get(this.serverUrl + "getsubloc?IsActivated=1", {headers: reqHeader,}).subscribe((data: any) => {
    ...
    getUsers() {
        ...
        this.http.get(this.serverUrl + "getusers", {headers: reqHeader,}).subscribe((data: any) => {
            this.usersList = data;
    ...
    save(){
        ...
        if(this.txtEmail == undefined || this.txtEmail.trim() == ''){
            ...
            this.toastr.errorToastr("Please Enter Valid Email", "Error !", { toastTimeout: 2500,});
            return false;
            ...
            this.toastr.errorToastr("Please Enter Complete CNIC", "Error !", { toastTimeout: 2500,});
            return false;
        }else if (this.ddlPost == undefined || this.ddlPost == ''){
            this.toastr.errorToastr("Please Select Post", "Error !", { toastTimeout: 2500,});
            return false;
        }else if (this.ddlUserRole == undefined || this.ddlUserRole == ''){
            this.toastr.errorToastr("Please Select Role", "Error !", { toastTimeout: 2500,});
            return false;
        }else{
        ...
        if (this.ddlLocations == undefined || this.ddlLocations == ''){
            ...
            this.http.post(this.serverUrl + "sduserloc", SaveData, {headers: reqHeader,}).subscribe((data: any) => {
                ...
                if (data.msg == "Success") {
                    ...
                    this.toastr.successToastr("Record Saved Successfully!","Success!",{toastTimeout: 2500,});
                    this.getUserLocations(this.userIDforLoc);
                    return false;
